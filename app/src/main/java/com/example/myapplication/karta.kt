...
fun karta(/*navController: NavHostController*/) {
    Column (
        ...
        TextField(
            ...
            modifier = Modifier.fillMaxWidth(3f).padding(top = 0.dp, bottom = 20.dp, start = 25.dp, end = 35.dp),
        ...
        TextField(
            ...
            {pol.value = it},
            // value = "example@mail.ru", onValueChange = {},
            modifier = Modifier.fillMaxWidth(3f).padding(top = 0.dp, bottom = 30.dp, start = 25.dp, end = 35.dp),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Phone),
            textStyle = TextStyle(color = Color.Black),
            shape = RoundedCornerShape(30),
